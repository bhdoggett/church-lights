...
Open `dist-electron/Lightz-0.1.1-arm64.dmg` (Apple Silicon) or `Lightz-0.1.1.dmg` (Intel) from Finder. Drag **Lightz** to Applications.
...
| Download                                                                                                      | For                         |
| ------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [Lightz-0.1.1-arm64.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.1.1/Lightz-0.1.1-arm64.dmg) | Apple Silicon (M1/M2/M3/M4) |
| [Lightz-0.1.1.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.1.1/Lightz-0.1.1.dmg)             | Intel Mac                   |
