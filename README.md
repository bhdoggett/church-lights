...
Open `dist-electron/Lightz-0.1.3-arm64.dmg` (Apple Silicon) or `Lightz-0.1.3.dmg` (Intel) from Finder. Drag **Lightz** to Applications.
...
| Download                                                                                                      | For                         |
| ------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [Lightz-0.1.3-arm64.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.1.3/Lightz-0.1.3-arm64.dmg) | Apple Silicon (M1/M2/M3/M4) |
| [Lightz-0.1.3.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.1.3/Lightz-0.1.3.dmg)             | Intel Mac                   |
